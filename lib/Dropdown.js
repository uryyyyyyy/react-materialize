  ...
  _createClass(Dropdown, [{
    ...
    value: function renderTrigger() {
      ...
      return _react2.default.cloneElement(trigger, {
        ref: function ref(t) {
          return _this2._trigger = '[data-target=' + _this2.idx + ']';
        },
        className: (0, _classnames2.default)(trigger.props.className, 'dropdown-trigger'),
...
Dropdown.propTypes = {
  ...
  options: _propTypes2.default.shape({
    ...
    coverTrigger: _propTypes2.default.bool,
