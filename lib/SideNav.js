...
var SideNav = function (_Component) {
  ...
  _createClass(SideNav, [{
    ...
    value: function render() {
      ...
      var classNames = (0, _classnames2.default)('sidenav', { 'sidenav-fixed': fixed || !trigger }, className);
    ...
    value: function renderTrigger() {
      ...
      var classNames = (0, _classnames2.default)(trigger.props.className, triggerView, 'sidenav-trigger');
      return _react2.default.cloneElement(trigger, {
        ref: function ref(t) {
          return _this2._trigger = '[data-target=' + _this2.id + ']';
        },
        'data-target': this.id,
