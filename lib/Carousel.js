  ...
  _createClass(Carousel, [{
    ...
    value: function renderItems(child, centerImages) {
      if (typeof child === 'string') {
        return _react2.default.createElement(
          'a',
          {
            className: (0, _classnames2.default)('carousel-item', {
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          centerImages = _props.centerImages,
      ...
      return elemsToRender && _react2.default.createElement(
        ...
        _react2.default.Children.map(elemsToRender, function (child) {
...
Carousel.propTypes = {
  ...
  */
  centerImages: _propTypes2.default.bool,
  /*
  ...
  */
  options: _propTypes2.default.shape({
    ...
    */
    numVisible: _propTypes2.default.number,
    /*
    ...
    */
    onCycleTo: _propTypes2.default.func
  })
};
