...
var CollectionItem = function CollectionItem(_ref) {
  ...
  var item = _react2.default.createElement(
    'li',
    _extends({}, other, { className: (0, _classnames2.default)('collection-item', className) }),
    children
  );
  ...
  if (href) {
    item = _react2.default.createElement(
      'a',
      _extends({}, other, { href: href, className: (0, _classnames2.default)('collection-item', className) }),
      children
    );
  }
